...
with st.sidebar:
    ...
    page = st.selectbox("Pilih Halaman", ("EDA", "Predict Approval"))
    st.markdown("<div class='sidebar-sub'>Gunakan menu ini untuk berpindah halaman</div>", unsafe_allow_html=True)
    st.write("")
    st.write("**About**")
    st.write("Page ini berisikan hasil analisis data pengajuan pinjaman serta prediksi status persetujuan berdasarkan atribut pemohon.")
